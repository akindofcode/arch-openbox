...
sudo pacman -S --noconfirm --needed screenfetch vim git gnome-terminal pcmanfm tint2 vivaldi vivaldi-ffmpeg-codecs nitrogen sublime-text nitrogen comtpon ntfs-3g gmrun
